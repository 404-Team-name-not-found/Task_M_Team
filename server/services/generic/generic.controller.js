...
/**
 * Used to generate a controller for given item
 * @param {genericService} service genericService instance
 * @param {object} itemSchema
 * @param {*} requiredParams parameters that are required for the item to exist
 * @param {*} itemName the name of the item
 * @returns
 */
const genericController = (service, itemSchema, requiredParams, itemName) => {
  const defaultSchema = {
    tags: [`Api ${itemName}`],
    body: {
      type: "object",
